...
define('DB_NAME', 'bd_ds2'); // set database name
define('SEND_ERRORS_TO', 'email@email.com' ); //set email notification email address
...
class DB
{
    ...
    public function get_call( $query )
    {
    ...
    */
    ...
    public function disconnect()
    {
		...
		/* Kill connection */
		mysqli_kill($this->link, $thread_id);
