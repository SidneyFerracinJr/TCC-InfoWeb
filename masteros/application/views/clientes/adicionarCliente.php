    ...
    echo '<div class="alert alert-danger">' . $custom_error . '</div>';
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal">
                  <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="nomeCliente" autofocus type="text" name="nomeCliente" value="<?php echo set_value('nomeCliente'); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <label for="contato" class="control-label">Apelido</label>
                        <div class="controls">
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="rua" type="text" name="rua" placeholder="Rua Exemplo, 999" value="<?php echo set_value('rua'); ?>" />
                        </div>
                    </div>
