                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal">
                  ...
                  <div class="control-group">
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="rua" type="text" name="rua" placeholder="Rua Exemplo, 999" value="<?php echo $result->rua; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="control-group" class="control-label">
                        <label for="cidade" class="control-label">Cidade<span class="required" style="color: red;">*</label>
                        <div class="controls">
                    ...
                    <div class="control-group" class="control-label">
                        <label for="estado" class="control-label">Estado<span class="required" style="color: red;">*</label>
                        <div class="controls">
