    ...
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vCliente')) : ?>
                ...
                <li class="bg_lb">
                    <span class="badge" style="font-size: 10px; float: right; background-color: transparent;">F1</span>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vProduto')) : ?>
                <li class="bg_lg">
                    <span class="badge" style="font-size: 10px; float: right; background-color: transparent;">F2</span>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vServico')) : ?>
                <li class="bg_ly">
                    <span class="badge" style="font-size: 10px; float: right; background-color: transparent;">F3</span>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
                <li class="bg_lo">
                    <span class="badge" style="font-size: 10px; float: right; background-color: transparent;">F4</span>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVenda')) : ?>
                <li class="bg_ls">
                    <span class="badge" style="font-size: 10px; float: right; background-color: transparent;">F6</span>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vGarantia')) : ?>
                <li class="bg_lb">
                    <span class="badge" style="font-size: 10px; float: right; background-color: transparent;">F7</span>
                    <a href="<?= base_url() ?>index.php/garantias"><i class="fas fa-book" style="font-size:36px"></i>
                        <div>Termo Garantia</div>
                    </a>
                </li>
            <?php endif ?>
        </ul>
