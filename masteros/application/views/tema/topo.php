...
<head>
  ...
  <title><?= $configuration['app_name'] ?: 'Sidney Ferracin Jr.' ?></title>
</head>

<body>
  <!--Header-part-->
  <div id="header">
    <h1><a href=""> <?= $configuration['app_name'] ?: 'Sidney Ferracin Jr.' ?> </a></h1>
  </div>
  <!--close-Header-part-->
  <!--top-Header-menu-->
  <div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
      ...
      <li class="pull-right"><a href="https://github.com/SidneyFerracinJr" target="_blank"><i class="fas fa-asterisk"></i> <span class="text">Versão:
