    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-md-6"><a class="btn btn-primary btn-sm float-right btn-icon-split" role="button" href="&lt;?php echo base_url(); ?&gt;index.php/clientes/adicionar"><span class="text-white-50 icon"><i class="fas fa-upload"></i></span><span class="text-white text">Adicionar Arquivos</span></a></div>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
            ...
            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                <table class="table dataTable my-0" id="dataTable">
                    ...
                    <tfoot>
                        <tr>
                            <td class="text-center"><strong>Ícone</strong></td>
