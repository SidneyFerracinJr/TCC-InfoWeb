...
class Arquivos extends MY_Controller
{
    ...
    /**
     * author: Sidney Ferracin Jr.
     * email: sidney.ferracin99@gmail.com
     *
     */
    ...
    public function do_upload()
    {
        ...
        $config['allowed_types'] = 'txt|jpg|jpeg|gif|png|pdf|docx|html|xlsx|pub|pptx|rar|TXT|JPG|JPEG|GIF|PNG|PDF|DOCX|HTML|XLSX|PUB|PPTX|RAR';
        $config['max_size'] = 0;
